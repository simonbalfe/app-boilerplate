...
|-------|----------|----------------|
| Router | `packages/api/src/routes/` | HTTP: validation, auth, responses |
| Service | `packages/{domain}/src/services/` | Business logic, orchestration |
| Query | `packages/db/src/queries/` | Drizzle calls |
