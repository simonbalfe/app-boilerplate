---
description: React component patterns, TanStack Router, hooks, and frontend module organization
alwaysApply: true
---
...
- File-based routing in `apps/web/src/app/`
- Use `createFileRoute` for route definitions
- Loaders for server-side data fetching
- TanStack Query for client-side cache and mutations
...
- shadcn/ui component patterns in `apps/web/src/components/ui/`
